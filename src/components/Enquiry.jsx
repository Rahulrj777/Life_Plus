...
const Enquiry = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbxLGjkEdGQSByzsirddDpMvLICzj_6fxRu6tkdv8ovSPzhnNeho8Wf0uGGhWfZ1Gq_TQA/exec"; // Replace with your actual script URL
        ...
        <div className="max-w-md mx-auto overflow-hidden">
          <div className="md:flex">
            <div className="w-full md:px-1 py-8">
              <h2
                className="text-[16px] md:text-[20px] font-semibold uppercase text-white text-center"
                data-aos="fade-right"
                data-aos-delay="50"
              ...
              <form className="mt-10" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-y-6 md:flex-row items-center gap-x-3 w-full mb-6 md:mb-10">
                  <div className="w-full">
                    <label
                      className="block text-[12px] md:text-[14px] font-semibold mb-2 text-gray-50"
                      htmlFor="name"
                    >
                      Name
                    </label>
                  ...
                  <div className="w-full">
                    <label
                      className="block text-[12px] md:text-[14px] text-gray-50 font-semibold mb-2"
                      htmlFor="phone"
                    >
                      Phone Number
                    </label>
                ...
                <div className="mb-6 md:mb-10">
                  ...
                  >
                    ...
                    <option className="bg-black" value="Siddha Treatments">
                      Siddha Treatments
                    </option>
                    <option className="bg-black" value="Ayurveda Therapies">
                      Ayurveda Therapies
                    </option>
                    <option className="bg-black" value="Naturopathy Therapies">
                      Naturopathy Therapies
                    </option>
                    <option
                      className="bg-black"
                      value="Lifestyle & Holistic Wellness"
                    >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full cursor-pointer hover:bg-[#c77c9a] rounded-xl bg-[#d480a1] uppercase text-white font-semibold text-[13px] py-3 px-4 focus:outline-none focus:shadow-outline duration-500 ${
                    loading
