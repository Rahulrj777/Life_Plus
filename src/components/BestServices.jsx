    ...
    <div className="relative w-full md:w-full mx-auto overflow-hidden px-1 pb-4 ">
            ...
            <div className="text-center relative pb-8 md:pb-12 w-full">
              ...
              <div className="flex justify-center items-center w-full ">
                <div className="px-5 md:px-4 py-3 md:py-2 rounded-lg drop-shadow-sm bg-white border border-gray-100 ">
                  <img
                    src={slide.img}
                    className="text-3xl font-bold text-gray-950 mb-2 w-9  md:w-10 object-cover "
                  />
                </div>
              </div>

              <div className="mt-4 ">
                <h3 className="text-center text-[9px] md:text-[11px]  font-medium font-[Merriweather]">
                  {slide.title}
                </h3>
              </div>
            </div>
      ...
      <div className="flex items-center gap-x-4 md:gap-x-8 justify-start w-full px-4 md:w-[90%] ">
        <div className="z-10">
          <button
            onClick={moveLeft}
            className="cursor-pointer bg-white hover:bg-[#20a534] hover:border hover:border-gray-100 text-[#20a534] hover:text-gray-50 p-2 hover:scale-105 duration-100 rounded-full shadow-lg"
          >
