          ...
          <div className="px-5 md:px-0 w-full md:w-[85%] mx-auto space-y-12">
            ...
            <div className="flex flex-col justify-center items-center gap-y-2 w-full md:w-[80%] mx-auto mb-10">
              ...
              <p className="text-[12px] md:text-[14px] font-[roboto] text-gray-500 text-justify md:text-center w-[90%] mx-auto mt-2 md:mt-0">
                At Life Plus Ayush Vaidhyasala, our Physiotherapy Department is
                committed to providing world-class care for both in-patients and
                out-patients. With personalized treatment plans, patient
                education, guided home exercise programs, and evidence-based
                techniques, we ensure that every individual receives holistic
                and effective rehabilitation. Our team combines expertise in
                human anatomy and physiology with compassion to help patients
                restore mobility, reduce pain, and achieve a better quality of
                life.
              </p>
            </div>
              ...
              <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                ...
                <div className="flex flex-col items-start gap-y-2 py-2 md:py-4 px-4">
                  ...
                  <p className="font-[roboto] text-[12px] md:text-[14px] text-gray-600">
                    The Physiotherapy Department at Life Plus Ayush vaidhyasala
                    is dedicated to delivering both in-patient and out-patient
                    services with the highest standards of care and quality. Our
                    approach focuses on thorough assessments and personalized
                    treatment plans that integrate education, ongoing support,
                    tailored home exercise programs, and professional guidance.
                    By applying our deep scientific knowledge of human anatomy
                    and physiology, we ensure the delivery of effective and
