              ...
              <div>
                <div className="flex flex-col justify-center items-center gap-y-2 w-full md:w-[80%] mx-auto mb-14 md:mb-20">
                  ...
                  <p className="text-[10px] md:text-[12px] font-[roboto] text-gray-500 text-justify md:text-center w-[90%] mx-auto mt-2 md:mt-0">
                    Discover the ancient secrets of holistic well-being through
                    authentic Panchakarma treatments and personalized Ayurvedic
                    therapies. Rooted in centuries-old wisdom, our therapies aim
                    to detoxify, rejuvenate, and restore balance to your body,
                    mind, and spirit
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-16 md:gap-y-24 w-full">
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Abhyangam is a full-body herbal oil massage that
                        detoxifies, relieves stress, and enhances circulation
                        for overall health.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Nasya Karma is one of the five Panchakarma therapies in
                        Ayurveda, where medicated oils, powders, or herbal
                        extracts are administered through the nasal passages.
                        This therapy directly benefits the brain, sinuses, and
                        nervous system, making it effective for sinusitis,
                        migraines, sleep issues, hormonal imbalances, and hair
                        problems. It also helps in conditions like anxiety, and
                        cognitive disorders. Nasya helps to clear toxins from
                        the head, Improves breathing, strengthens hair roots,
                        sharpens memory.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Vamana is one of the five Panchakarma therapies in
                        Ayurveda, where controlled therapeutic vomiting is
                        induced to expel excess Kapha dosha and toxins from the
                        upper digestive tract. This deep detox helps reset
                        digestion, boost metabolism, and improve overall health.
                        Vamana is especially useful in conditions like asthma,
                        chronic cough, sinusitis, allergies, skin diseases (like
                        psoriasis and eczema), obesity, and metabolic disorders.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Virechana is a special Panchakarma therapy where the
                        body is gently cleansed through a controlled purgation
                        process. It helps remove toxins from the digestive
                        system and improves overall metabolism. This treatment
                        is highly effective for digestive problems, obesity,
                        high cholesterol, diabetes, liver and spleen disorders,
                        skin diseases, PCOS, and infertility.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Vasti is a key Panchakarma therapy where medicated oils
                        or herbal decoctions are administered through the anal
                        canal. It deeply detoxifies the body, balances vata
                        dosha, and restores healthy bowel movements. Vasti is
                        especially effective for constipation, arthritis, back
                        pain, nerve disorders, infertility, autoimmune
                        conditions, and a wide range of vata-related problems.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Bloodletting therapy for skin diseases and blood
                        purification, promoting clear skin and wellness.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Shirodhara is a Ayurvedic therapy where a gentle stream
                        of warm medicated oil or other healing liquids like
                        milk, buttermilk is steadily poured on the forehead.
                        This procedure calms the nervous system, balances the
                        mind, and relieves stress, anxiety, and sleep problems.
                        It is also beneficial for headaches, sinus issues,
                        neurological disorders, and mental fatigue. Shirodhara
                        not only promotes deep relaxation but also improves
                        focus, memory, and overall mental clarity.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Navarakizhi is a unique Ayurvedic therapy where warm
                        boluses made of special medicinal rice (Navara) are
                        massaged over the body in herbal milk or decoction. This
                        treatment deeply nourishes the muscles, strengthens the
                        nerves, and improves flexibility. It is especially
                        useful in joint pain, arthritis, facial paralysis,
                        muscular weakness, and post-stroke recovery. Navarakizhi
                        also enhances skin health, promotes better sleep, and
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Thalapothichil (Shirolepa) is a cooling Ayurvedic head
                        therapy where a medicated herbal paste is gently applied
                        to the scalp. It calms the mind, and improves sleep
                        quality. This treatment is highly beneficial for stress,
                        anxiety, hypertension, migraines, insomnia, and scalp
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Herbal powder pouch massage to relieve pain, stiffness,
                        and muscle tension, aiding in recovery and relaxation.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group bg-[#f5f6f6] rounded-md pb-2 md:pb-3 h-full drop-shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start gap-y-1  md:gap-y-2 py-1 md:py-3 px-4">
                      ...
                      <p className="font-[roboto] text-[11px] md:text-[13px]">
                        Bashpaswedam is One of the sweating ( svedanam ) methods
                        in ayurveda, usually done after Abhyangam. The herbal
                        steam opens up skin pores, allowing better absorption of
                        the medicated oil while relaxing the body. This therapy
                        decreases muscle stiffness, joint pain, heaviness, and
                        improves circulation and metabolism. It is especially
                        useful in conditions like arthritis, spondylosis,
                        obesity, and body pain.
                      </p>
                    </div>
                  </div>
                </div>
