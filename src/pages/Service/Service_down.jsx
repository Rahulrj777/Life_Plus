    ...
    <>
          ...
          <div className="flex flex-col md:flex-row gap-y-14 items-center justify-center ">
            <div className="w-full md:w-[50%] mx-auto">
              <div className="flex flex-col gap-y-1 justify-center items-start  mb-8 md:mb-12">
                <p className="text-[10px]  md:text-[12px] font-semibold text-[#a64c4f]">
                  Specialized in
                </p>
                <h2 className="font-[roboto] text-gray-600   font-semibold text-[13px] md:text-[18px] text-start  ">
                  We specialize in holistic Siddha and Ayurvedic treatments,
                  focusing on pain relief, rejuvenation, detox, and restoring
                  balance to the body and mind naturally.{" "}
                </h2>
              </div>
              ...
              <div>
                <div>
                  <img
                    src={bottombanner}
                    className="w-full object-cover rounded-md md:rounded-xl shadow-2xl drop-shadow-lg"
                    alt="none"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-center w-full md:ml-14">
                <div className="grid grid-cols-3 md:grid-cols-4  md:gap-x-14  gap-y-6 md:gap-y-14 w-full">
                  <div className="flex flex-col items-center gap-y-2">
                    ...
                    <span className="font-[roboto] text-[10px] md:text-[12px]">
                      Back Pain
                    </span>
                  </div>
      ...
      <section className="py-10 md:py-20 bg-slate-100 font-[poppins]">
        <div className="w-full px-4 md:w-[90%] mx-auto">
          <div
            className="flex flex-col items-center gap-y-3 mb-8 md:mb-12"
            data-aos="fade-up"
            data-aos-duration="2000"
            data-aos-delay="50"
          >
            <h3 className="font-bold text-[16px] md:text-[32px] font-[Merriweather] ">
              Popular Ayurveda Therapies
            </h3>
            <p className="text-[10px] md:text-[12px] text-gray-600 text-center">
              Embrace the wisdom of nature with Ayurveda, a holistic approach to
              wellness that promotes balance and supports your journey to
              optimal health.
            </p>
          </div>
