    ...
    <>
      ...
      <div className="overflow-hidden">
        <div className="fixed right-4 md:right-8 bottom-10 md:bottom-16 z-50 flex flex-col gap-4">
          {/* WhatsApp */}
          <a
            href="https://api.whatsapp.com/send?phone=918015907797&text=Hello,%20I%20am%20interested%20in%20your%20services."
            target="_blank"
            ...
            <div className="flex flex-col md:flex-row  gap-y-12 justify-center ">
              <div className="w-full md:w-[50%] mx-auto">
                <div className="flex items-center justify-center relative">
                  ...
                  <div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full  md:py-0 px-5"
                    data-aos="zoom-out"
                    data-aos-duratoin="1000"
                  >
                    <div className="bg-white p-3 md:p-4 overflow-hidden  h-full  w-[80%] md:w-[50%] mx-auto rounded-bl-4xl">
                      <div className="bg-white p-3 md:p-7  mx-auto border-2 border-[#0a7c1d] rounded-bl-3xl  space-y-1 md:space-y-3">
                        ...
                        <h3 className="text-center font-bold text-[10px] md:text-[16px]">
                          Renew Yourself with Ayurveda
                        </h3>
                        <p className="text-[10px] md:text-[12px] text-center">
                          Discover the ancient healing power of Ayurveda to
              ...
              <div className="w-full md:w-[50%] mx-auto">
                <div data-aos="fade-left" data-aos-duratoin="1000">
                  <p className="text-[#d480a1] text-[12px] md:text-[13px] font-semibold uppercase md:mb-2">
                    About Us{" "}
                  </p>
                  <p className="text-[12px] md:text-[14px] text-gray-500 mt-2  md:mt-5">
                    At our core, we honor the age-old wisdom of traditional
                    healing. Drawing from the rich heritage of Siddha, Ayurveda,
                    and other time-tested practices, we offer safe, plant-based
                    therapies that are designed to optimize your health. Our
                    herbal treatments support stress reduction, boost energy,
                    and enhance overall well-being—all grounded in
                    evidence-informed care and guided by nature’s healing power.
                    With a deep respect for ancient remedies and a commitment to
                    holistic wellness, we help you achieve balance in body,
                    mind, and spirit. This is not just healthcare—it’s
                    tradition, thoughtfully renewed for modern lives.
                  </p>
                  ...
                  <ul className="grid grid-cols-2 md:grid-cols-3 gap-x-2 md:gap-x-4 gap-y-4  md:gap-y-8  text-[10px] md:text-[12px] font-semibold ">
                    <li className="flex items-center gap-x-2">
                      ...
                      <span>
                        <img
                          src={who1}
                          className="w-5 md:w-7 object-cover"
                          alt="none"
                        />
                      </span>{" "}
                      <span>Herbal Expertise</span>{" "}
                    </li>
                    <li className="flex items-center gap-x-2">
                      {" "}
                      <span>
                        <img
                          src={who2}
                          className="w-6 md:w-8 object-cover"
                          alt="none"
                        />
                      </span>{" "}
        ...
        <section className="pt-14 pb-20 md:py-24 bg-white relative overflow-hidden">
          <div className="w-full px-4 md:w-[80%] mx-auto relative z-10">
            ...
            <div className="text-center mb-16">
              <p className="text-[16px] md:text-[18px] font-semibold mb-2 text-[#d480a1]">
                Our Services
              </p>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Card 1 */}
                <Link
                  to="/services/Siddha External Therapies"
                  className="h-full"
                >
                  <div className="bg-white drop-shadow-lg px-6 py-8 rounded-lg border-t-4 border-[#687445] hover:scale-105 transition-all duration-300 h-full flex flex-col">
                    <div className="flex flex-col items-center gap-4 flex-grow">
                      ...
                      <p className="text-[11px] md:text-[12px] text-gray-600 text-center">
                        Siddha therapies focus on external treatments to balance
                        the body's energy and promote natural healing.
                      </p>
                    </div>
                  </div>
                </Link>
                ...
                {/* Card 2 */}
                <Link
                  to="/services/Ayurveda Panchakarma & Wellness Therapies"
                  className="h-full"
                >
                  <div className="bg-white drop-shadow-lg px-6 py-8 rounded-lg border-t-4 border-[#687445] hover:scale-105 transition-all duration-300 h-full flex flex-col">
                    <div className="flex flex-col items-center gap-4 flex-grow">
                      <img
                        src={service3}
                        className="w-14 md:w-20 object-cover"
                        alt="Ayurveda Panchakarma & Wellness Therapies"
                      />
                      <h3 className="text-[14px] font-bold text-[#687445] text-center">
                      ...
                      <p className="text-[11px] md:text-[12px] text-gray-600 text-center">
                        ...
                        rejuvenation therapies for detoxification, restoration,
                ...
                {/* Card 3 */}
                <Link
                  to="/services/Lifestyle & Holistic Wellness"
                  className="h-full"
                >
                  <div className="bg-white drop-shadow-lg px-6 py-8 rounded-lg border-t-4 border-[#687445] hover:scale-105 transition-all duration-300 h-full flex flex-col">
                    <div className="flex flex-col items-center gap-4 flex-grow">
                      <img
                        src={service1}
                        className="w-14 md:w-20 object-cover"
                        alt="Lifestyle & Holistic Wellness"
                      />
                      <h3 className="text-[14px] font-bold text-[#687445] text-center">
                        Lifestyle & Holistic Wellness
                      </h3>
                      <p className="text-[11px] md:text-[12px] text-gray-600 text-center">
                        Personalized lifestyle programs and holistic wellness
                        guidance to maintain balance in body, mind, and spirit.
                      </p>
                    </div>
                  </div>
                </Link>
                  ...
                  <div className="bg-white drop-shadow-lg px-6 py-8 rounded-lg border-t-4 border-[#687445] hover:scale-105 transition-all duration-300 h-full flex flex-col">
                    <div className="flex flex-col items-center gap-4 flex-grow">
                      <img
                        src={service3}
                        className="w-14 md:w-20 object-cover"
                        alt="Naturopathy Therapies"
                      />
                      <h3 className="text-[14px] font-bold text-[#687445] text-center">
                        Naturopathy Therapies
                      </h3>
                      <p className="text-[11px] md:text-[12px] text-gray-600 text-center">
                        Naturopathy restores health using elements of nature
                        like water, mud, air, and plant-based remedies.
                      </p>
                    </div>
                  </div>
                </Link>
                ...
                <Link to="/services/Physiotherapy" className="h-full">
                  <div className="bg-white drop-shadow-lg px-6 py-8 rounded-lg border-t-4 border-[#687445] hover:scale-105 transition-all duration-300 h-full flex flex-col">
                    <div className="flex flex-col items-center gap-4 flex-grow">
                      ...
                      <p className="text-[11px] md:text-[12px] text-gray-600 text-center">
                        Targeted physiotherapy programs to improve mobility,
                        strength, and recovery after injury or chronic
                        conditions.
                      </p>
                    </div>
                  </div>
          ...
          <div className="relative h-[85rem] md:h-[45rem]">
            ...
            <div className="absolute inset-0 flex justify-center items-center text-center px-4">
              <div className="w-full max-w-7xl">
                {/* Heading */}
                <div
                  className="w-full mx-auto mb-10 md:mb-14"
                  data-aos="fade-up"
                  data-aos-duration="1000"
                >
                  <p className="text-[16px] md:text-[18px] font-semibold text-[#d480a1] mb-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
                      ...
                      <div className="relative h-40 w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        ...
                        <div className="absolute inset-0 bg-white text-gray-700 flex items-center justify-center p-4 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-md">
                          <p className="text-[12px] md:text-[14px]">
                            Tailored therapies designed to match your unique
                    ...
                    <div className="group [perspective:1000px]">
                      <div className="relative h-40 w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        ...
                        <div className="absolute inset-0 bg-white text-gray-700 flex items-center justify-center p-4 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-md">
                          <p className="text-[12px] md:text-[14px]">
                            Holistic solutions to naturally support recovery and
                    ...
                    <div className="group [perspective:1000px]">
                      <div className="relative h-40 w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        ...
                        <div className="absolute inset-0 bg-white text-gray-700 flex items-center justify-center p-4 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-md">
                          <p className="text-[12px] md:text-[14px]">
                            Safe, evidence-informed, and chemical-free
                    ...
                    <div className="group [perspective:1000px]">
                      <div className="relative h-40 w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        ...
                        <div className="absolute inset-0 bg-white text-gray-700 flex items-center justify-center p-4 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-md">
                          <p className="text-[12px] md:text-[14px]">
                            Quick support and guidance in critical situations to
                    ...
                    <div className="group [perspective:1000px]">
                      <div className="relative h-40 w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        ...
                        <div className="absolute inset-0 bg-white text-gray-700 flex items-center justify-center p-4 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-md">
                          <p className="text-[12px] md:text-[14px]">
                            Our treatments are powered by centuries-old herbal
                    ...
                    <div className="group [perspective:1000px]">
                      <div className="relative h-40 w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        ...
                        <div className="absolute inset-0 bg-white text-gray-700 flex items-center justify-center p-4 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-md">
                          <p className="text-[12px] md:text-[14px]">
                            Experienced and certified practitioners offering
                            trusted, expert care.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="group [perspective:1000px]">
                      <div className="relative h-40 w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        ...
                        <div className="absolute inset-0 bg-white text-gray-700 flex items-center justify-center p-4 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-md">
                          <p className="text-[12px] md:text-[14px]">
                            Round-the-clock assistance for any health concerns,
                            anytime you need us.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="group [perspective:1000px]">
                      <div className="relative h-40 w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        ...
                        <div className="absolute inset-0 bg-white text-gray-700 flex items-center justify-center p-4 text-center [transform:rotateY(180deg)] [backface-visibility:hidden] rounded-md">
                          <p className="text-[12px] md:text-[14px]">
                            Chemical-free, plant-based therapies for
                            sustainable, holistic healing.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="py-10 md:py-14 ">
              <div className="w-full md:w-[85%] mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-white">
                  <div>
                    <h2 className="text-[20px] md:text-[48px] font-bold">
        ...
        <section className="py-16 md:py-24 bg-[#f9f3eb] relative overflow-hidden">
          <div
            className="w-full px-6 md:w-[75%] mx-auto text-center relative z-10"
            data-aos="fade-up"
          ...
          >
            ...
            <p className="text-[13px] md:text-[16px] text-gray-600 leading-6 md:leading-8 mb-8 md:mb-12 max-w-3xl mx-auto">
              Harness the proven benefits of herbal medicine with our safe,
              plant-based therapies designed to optimize your health. From
              stress reduction to energy enhancement, our treatments support
              your well-being using time-tested natural ingredients and
            ...
            >
              Discover More{" "}
              <FaArrowRight className="text-[12px] md:text-[18px]" />
            </Link>
          </div>
        </section>
        ...
        <section className="py-6 md:py-10 bg-white">
          <div className="w-full flex justify-center items-center relative ">
            ...
            <div
              className="flex flex-col md:flex-row items-center  md:gap-x-10 bg-white z-40 border border-gray-200 px-5 md:px-16 py-2 md:py-4 rounded-xl  md:rounded-4xl"
              data-aos="fade-up"
              data-aos-duratoin="1000"
            >
              <h3 className="font-light text-[8px] md:text-[14px] flex items-center gap-x-2 md:gap-x-4">
                <span>
                  {" "}
                  <PiHeadsetFill className="text-[#687445] text-[20px] md:text-[40px]" />{" "}
                </span>
                <span>
                  {" "}
                  Begin your personalized wellness journey with Life Plus.{" "}
                </span>
              </h3>
              <div>
                <Link to="/contact" onClick={() => window.scrollTo(0, 0)}>
                  <button className="px-3 md:px-6 cursor-pointer mt-1 md:mt-0 py-1.5 md:py-2.5 bg-[#d480a1] hover:scale-105 duration-300 font-bold hover:bg-[#687445] rounded-md md:rounded-xl text-[10px] md:text-[14px] text-white">
                    Contact us
                  </button>
                </Link>
              </div>
